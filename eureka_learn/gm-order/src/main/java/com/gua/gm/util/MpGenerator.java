...
public class MpGenerator {
    ...
    //表前缀，不需要则写空
    private static String tablePrefix = "pms_";
    //数据库连接url
    private static String dbUrl = "jdbc:mysql://localhost:3306/gm?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT&autoReconnect=true&useSSL=false";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"pms_order","pms_order_line"}); // 需要生成的表
