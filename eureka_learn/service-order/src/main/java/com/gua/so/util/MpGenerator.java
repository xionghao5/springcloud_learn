...
public class MpGenerator {
    ...
    //数据库连接url
    private static String dbUrl = "jdbc:mysql://localhost:3306/sce_seata?useUnicode=true&characterEncoding=UTF-8&serverTimezone=GMT&autoReconnect=true&useSSL=false";
    ...
    public static void main(String[] args) {
        ...
        strategy.setInclude(new String[]{"tb_account","tb_order","tb_stock"}); // 需要生成的表
        mpg.setStrategy(strategy);

        // 包配置
        PackageConfig pc = new PackageConfig();
        pc.setParent("com.gua");
        pc.setEntity("entity");
        pc.setMapper("mapper");
